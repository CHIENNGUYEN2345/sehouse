                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        ...
                        <div class="kt-portlet__head-actions">
                            ...
                            @if(\App\Http\Helpers\CommonHelper::getRoleName(\Auth::guard('admin')->user()->id, 'name') == 'super_admin')
                            <a class="btn btn-default btn-icon-sm"
                                    href="/admin/ticket/report">
                                Gửi email báo cáo
                            </a>
                            @endif
                    ...
                    <div class="row">
                        ...
                        @foreach($filter as $filter_name => $field)
                            @if($field['type'] == 'custom')
                                @include($field['field'], ['field' => $field, 'name' => $filter_name])
                            @else
