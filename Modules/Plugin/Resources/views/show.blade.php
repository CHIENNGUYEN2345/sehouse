                ...
                <div class="kt-portlet kt-portlet--tabs">
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-toolbar">
                            <ul class="nav nav-tabs nav-tabs-space-xl nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-brand"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link {{ @$_GET['status'] == 1 ? 'active' : '' }}"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link {{ @$_GET['status'] === '0' ? 'active' : '' }}"
                    ...
                    <div class="kt-portlet__body">
                        ...
                        foreach ($modules as $module_name => $module) {
                            $arr_code .= $module_name . '|';
                        }
//                        dd($arr_code);
                        $data = json_decode(@file_get_contents('https://service.webhobasoft.com/api/v1/plugin_repositories?arr_code=' . $arr_code));
                        ...
                        ?>
                        @foreach($modules as $module_name => $module)
                            @if(isset($module_data_arr[$module_name]))
                                <?php
                                $module_data = $module_data_arr[$module_name];
                                ?>
                                    ...
                                    <div class="border">
                                        <div class="row border-bottom p-3 m-0">
                                            <div class="col-lg-3 col-md-3 col-sm-12 col-12 p-0">
                                                <img data-src="{!! @$module_data['image'] !!}"
                                                     class="lazy" alt="{!! @$module_data['name'] !!}"
                                                     style="max-width: 100%">
                                            </div>
                                            ...
                                            <div class="col-lg-7 col-md-7 col-sm-12 col-12">
                                                <h3 style="max-width: 100%;
                                                            ...
                                                            white-space: nowrap;
                                                            overflow: hidden; ">
                                                    <a href="{!! @$module_data['link_detail'] !!}" target="_blank"
                                                ...
                                                <p style="margin: 0" class=""><cite>Bởi <a
                                                                href="{!! @$module_data['author_link'] !!}">{!! @$module_data['author'] !!}</a></cite>
                                                </p>
                                            ...
                                            <div class="col-lg-2 col-md-2 col-sm-12 col-12">
                                                <div class=" row p-0 text-center">
                                                    <div class="btn p-0 pt-2 pb-2 mb-2 border col-lg-12 col-md-12 col-sm-6 col-6 btn-action">
                                                        @if(@$_GET['status'] == 1 || array_key_exists($module_name, $modules_active))
                                                            <a class="btn-trigger-change-status" data-slug="akismet"
                                                               aria-label="Cài đặt {{ @$module_data['name'] }} ngay"
                                                               data-status="0"
                                                    ...
                                                    <div class="btn col-lg-12 col-md-12 col-sm-6 col-6 p-0 pt-2 pb-2 mb-2">
                                                        <a href="{!! @$module_data['link_detail'] !!}"
                                                           class=""
                                                           aria-label="{{ @$module_data['name'] }}"
                                                           data-title="{{ @$module_data['name'] }}">Chi tiết</a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                <div class="row">
                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12 text-left">
                                                        <div class="">
                                                            {!! \Modules\Plugin\Http\Helpers\PluginHelper::voteStar($module_data['review']) !!}
                                                            {{--<span class="">4,5 đánh giá dựa trên 843 đánh giá</span>--}}
                                                            <span class="" aria-hidden="true">({{ @number_format($module_data['review_count'], 0, '.', '.') }})</span>
                                                        </div>


                                                        <div class="">
                                                            {{ @number_format($module_data['actived'], 0, '.', '.') }}
                                                            lượt kích hoạt
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-8 col-md-8 col-sm-12 col-12 text-right">
                                                        <div class="">
                                                            <strong>Cập nhật lần
                                                                cuối:</strong> {{ @date('d/m/Y H:i', strtotime($module_data['updated_at'])) }}
                                                        </div>

                                                        <div class="">
                                                            <?php
                                                            $max_version_required = explode('.', $module_data['max_version_required']);
                                                            $max_version_required = (int)@$max_version_required[0] * 10000 + (int)@$max_version_required[1] * 100 + (int)@$max_version_required[2];

                                                            $min_version_required = explode('.', $module_data['min_version_required']);
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12 p-3 moudle-item">
                                    <div class="border">
                                        <div class="row border-bottom p-3 m-0">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-12 col-12 p-0">
                                                <img data-src="{{ \App\Http\Helpers\CommonHelper::getUrlImageThumb(@$settings['logo'], null, 150) }}"
                                                     class="lazy" alt=""
                                                     style="max-width: 100%">
                                            </div>
                                            ...
                                            <div class="col-lg-2 col-md-2 col-sm-12 col-12">
                                                <div class=" row p-0 text-center">
                                                    <div class="btn p-0 pt-2 pb-2 mb-2 border col-lg-12 col-md-12 col-sm-6 col-6 btn-action">
                                                        @if(@$_GET['status'] == 1 || array_key_exists($module_name, $modules_active))
                                                            <a class="btn-trigger-change-status" data-slug="akismet"
                                                               aria-label="Cài đặt {{ @$module_name }} ngay"
                                                               data-status="0"
                                                               data-name="{{ @$module_name }}">Hủy kích hoạt</a>
                                                        @elseif(array_key_exists($module_name, $modules))
                                                            <a class="btn-trigger-change-status" data-slug="akismet"
                                                    ...
                                                    <div class="btn col-lg-12 col-md-12 col-sm-6 col-6 p-0 pt-2 pb-2 mb-2">
                                                        <a href="{!! @$module_data['link_detail'] !!}"
                                                           ...
                                                           data-title="{{ @$module_name }}">Chi tiết</a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                <div class="row">
                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12 text-left">
                                                        <div class="">
                                                            {{--                                                            <span class="">4,5 đánh giá dựa trên 843 đánh giá</span>--}}
                                                            <i class="flaticon-star" style="color: #ffb900"></i>
                                                            <i class="flaticon-star" style="color: #ffb900"></i>
                                                            <i class="flaticon-star" style="color: #ffb900"></i>
                                                            <i class="flaticon-star" style="color: #ffb900"></i>
                                                            <i class="flaticon-star" style="color: #ffb900"></i>
