<a href="/admin/{{ $module['code'] }}/{{ $item->id }}{{ isset($_GET['marketing_mail_id']) ? '?marketing_mail_id=' . $_GET['marketing_mail_id'] : '' }}"
...
@if( (\Auth::guard('admin')->user()->id == $item->admin_id &&
        ...
        @\Modules\EduMarketing\Models\MaketingMail::find(@$_GET['marketing_mail_id'])->status != 0)
