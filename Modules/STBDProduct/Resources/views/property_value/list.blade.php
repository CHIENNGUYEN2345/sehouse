        ...
        <div class="kt-portlet kt-portlet--mobile">
                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        ...
                        <div class="kt-portlet__head-actions">
                            ...
                            &nbsp;
                            <a href="{{ url('/admin/'.$module['code'].'/add/') }}{{isset($_GET['properties_name_id']) ? '?properties_name_id='.$_GET['properties_name_id'] : ''}}"
            ...
            <div class="kt-portlet__body kt-portlet-search @if(!isset($_GET['search'])) no-padding @endif">
                ...
                <form class="kt-form kt-form--fit kt-margin-b-20 form-search" id="form-search" method="GET" action=""
                    ...
                    <input name="limit" type="hidden" value="{{ $limit }}"><input type="hidden" name="quick_search" value="{{ @$_GET['quick_search'] }}" id="quick_search_hidden" class="form-control" placeholder="Tìm kiếm nhanh theo {{ @$quick_search['label'] }}"><input type="hidden" name="quick_search" value="{{ @$_GET['quick_search'] }}" id="quick_search_hidden" class="form-control" placeholder="Tìm kiếm nhanh theo {{ @$quick_search['label'] }}">
                    <div class="row">
                    ...
                    <div class="row">
						...
						<span>
                            ...
                            <a class="btn btn-secondary btn-secondary--icon" id="kt_reset" title="Xóa bỏ bộ lọc"
                               href="/admin/{{ $module['code'] }}{{isset($_GET['properties_name_id']) ? '?properties_name_id='.$_GET['properties_name_id'] : ''}}">
						<span>
