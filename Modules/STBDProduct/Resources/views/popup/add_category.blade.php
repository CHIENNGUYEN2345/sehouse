        ...
        <div class="modal-content" style="width:100%;height:100%">
            <form action="post" autocomplete="off" id="form-create-category_product">
                ...
                <div class="modal-body">
                    ...
                    $field_parent_id = ['name' => 'parent_id', 'type' => 'custom', 'field' => 'stbdproduct::form.fields.select_model_tree', 'class' => '', 'label' => 'Danh mục cha', 'model' => \Modules\STBDProduct\Models\Category::class];
                    ?>
