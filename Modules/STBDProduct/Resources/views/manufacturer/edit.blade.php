...
{{--                                   href="/admin/product/{{ $result->id }}/editor">--}}
{{--                                    <i class="la la-check"></i>--}}
{{--                                    <span class="kt-hidden-mobile">Editor</span>--}}
{{--                                </a>--}}
{{--                            @endif--}}
{{--                            @if($result->company_id == null && !in_array('super_admin', $permissions))--}}
{{--                                <a class="btn btn-success"--}}
{{--                                   href="/admin/{{ $module['code'] }}/{{ $result->id }}/get-to-my-company">--}}
{{--                                    <i class="la la-check"></i>--}}
{{--                                    <span class="kt-hidden-mobile">Lấy về kho</span>--}}
{{--                                </a>--}}
{{--                            @endif--}}
                            <div class="btn-group">
