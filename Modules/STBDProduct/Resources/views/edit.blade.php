...
@section('main')
                ...
                <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile"
                    ...
                    <div class="kt-portlet__head kt-portlet__head--lg" style="">
                        ...
                        <div class="kt-portlet__head-toolbar">
                            <a href="{{ \Modules\ThemeSTBD\Http\Helpers\CommonHelper::getProductSlug($result) }}" class="btn btn-clean kt-margin-r-10" target="_blank">Xem sản phẩm</a>
            ...
            <div class="col-xs-12 col-md-4">
                ...
                <div class="kt-portlet" data-ktportlet="true" id="kt_portlet_tools_1">
                    ...
                    <div class="kt-form">
                        <div class="kt-portlet__body">
                            <div class="kt-section kt-section--first">
                                @foreach($module['form']['related_products_tab'] as $field)
                                    @php
                                        $field['value'] = @$result->{$field['name']};
                                    @endphp
                                    <div class="form-group-div form-group {{ @$field['group_class'] }}"
                                ...
                                @endforeach
                                <div class="form-group-div form-group" id="form-group-code">
                                    <label for="code">Link WSS </label>
                                    <div class="col-xs-12">
                                        <input type="text" name="link_wss" class="form-control " id="code" value="{{$result->link_wss}}" placeholder="Link WSS">
                                    </div>
                                </div>
                            </div>
    ...
    @include('stbdproduct::popup.add_category')
    @include('stbdproduct::popup.add_tag')
@endsection
@section('custom_head')
