                                        ...
                                        <ul class="kt-nav">
                                            ...
                                            <li class="kt-nav__item">
                                                <a class="kt-nav__link export-excel" title="Xuất các bản ghi đang lọc ra file excel"
                                                   onclick="multiExport();">
                                                    ...
                                                    <span class="kt-nav__link-text">Xuất Excel Theo Bộ Chọn</span>
                                                </a>
                                            </li>
                                            <li class="kt-nav__item">
                                                <a class="kt-nav__link export-excel" title="Xuất các bản ghi đang lọc ra file excel"
                                                   ...
                                                   onclick="$('input[name=export]').click();">
                                                    <i class="kt-nav__link-icon la la-file-excel-o"></i>
                                                    <span class="kt-nav__link-text">Xuất Excel Theo Bộ Lọc</span>
                                                </a>
                                            </li>
                                            <li class="kt-nav__item">
                                                <a class="kt-nav__link export-image"
                                                   onclick="multiExportImage();">
                                                    {{--                                                   onclick="$('input[name=export_image]').click();">--}}
                                                    <i class="kt-nav__link-icon la la-file-image-o"></i>
                                                    <span class="kt-nav__link-text">Xuất Ảnh Theo Bộ Chọn</span>
                                                </a>
                                            </li>
                                            <li class="kt-nav__item">
                                                <a class="kt-nav__link export-image"
                                                   ...
                                                   onclick="$('input[name=export_image]').click();">
                                                    <i class="kt-nav__link-icon la la-file-image-o"></i>
                                                    <span class="kt-nav__link-text">Xuất Ảnh Theo Bộ Lọc</span>
                                                </a>
                                            </li>
                                            ...
                                            <li class="kt-nav__item">
                                                <a href="#" class="kt-nav__link" onclick="multiDelete();" title="Xóa tất cả các dòng đang được tích chọn">
                                                    ...
                                                    <span class="kt-nav__link-text">Xóa Theo Bộ Chọn</span>
                                                </a>
                                            </li>
            ...
            <div class="kt-portlet__body kt-portlet-search @if(!isset($_GET['search'])) no-padding @endif">
                ...
                <form class="kt-form kt-form--fit kt-margin-b-20 form-search" id="form-search" method="GET" action=""
                    ...
                    <input name="export"
                           {{--                           onclick="multiExport();"--}}
                           type="submit"
                           value="export" style="display: none;">
                    <input name="export_image"
                           type="submit"
                           value="export_image" style="display: none;">
                    ...
                    <table class="table table-striped">
                        ...
                        <tr class="kt-datatable__row" style="left: 0px;">
                            ...
                            @foreach($module['list'] as $field)
                                <th data-field="{{ $field['name'] }}" style="width: 30%;"
...
@section('custom_head')
    ...
    <script>
        function multiExport() {
            ...
            if (ids.length == 0) {
                alert('Bạn chưa chọn bản ghi nào để xuất!');
            } else {
                window.location.href = "/admin/{{ $module['code'] }}/get-data-export?ids=" + id_str; //  1,2,3,5
            }
        }

        function multiExportImage() {
            var ids = [];
            var id_str = '';
            $('.ids:checkbox:checked').each(function (i) {
                ids[i] = $(this).val();
            ...
            if (ids.length == 0) {
                ...
                window.location.href = "/admin/{{ $module['code'] }}/get-data-image-export?ids=" + id_str; //  1,2,3,5
            }
        }
