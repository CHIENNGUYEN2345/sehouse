...
@section('main')
    <?php
    if (isset($result->doom)) {
        $dooom = json_decode($result->doom);
    } else {
        $dooom = [];
    }

    ?>
    {{--    @include('stbdautoupdatepricewss::childs.breadcrumb')--}}
                ...
                <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile"
                    ...
                    <div class="kt-portlet__head kt-portlet__head--lg" style="">
                        ...
                        <div class="kt-portlet__head-toolbar">
                            ...
                            <a href="/admin/website" class="btn btn-clean kt-margin-r-10">
                                <i class="la la-arrow-left"></i>
                                <span class="kt-hidden-mobile">Quay lại</span>
                            </a>
                            <a href="/admin/website/{{ $result->id }}/test" class="btn btn-clean kt-margin-r-10" target="_blank">
                                <i class="la la-arrow-left"></i>
                                <span class="kt-hidden-mobile">Chạy thử</span>
                            </a>
                            <div class="btn-group">
            ...
            <div class="col-xs-12 col-md-6">
                    ...
                    <div class="kt-form">
                        <div class="kt-portlet__body">
                            <div class="kt-section kt-section--first">
                                @foreach($module['form']['category_tab'] as $field)
                                    @php
                ...
                <div class="kt-portlet" data-ktportlet="true" id="kt_portlet_tools_1">
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">
                                Target sản phẩm trong trang danh mục
                            </h3>
                        </div>
                        <div class="kt-portlet__head-group pt-3">
                            <a title="Xem thêm" href="#" data-ktportlet-tool="toggle"
                    ...
                    <div class="kt-form">
                        <div class="kt-portlet__body">
                            <div class="kt-section kt-section--first">
                                ...
                                @foreach($module['form']['category_target_tab'] as $field)
                                    @php
                                        $field['value'] = @$dooom->{$field['name']};
            ...
            <div class="col-xs-12 col-md-6">
                ...
                <div class="kt-portlet" data-ktportlet="true" id="kt_portlet_tools_1">
                    ...
                    <div class="kt-form">
                        <div class="kt-portlet__body">
                            <div class="kt-section kt-section--first">
                                @foreach($module['form']['product_doom_tab'] as $field)
                                    @php
                                        $field['value'] = @$dooom->{$field['name']};
                                    @endphp
                                    <div class="form-group-div form-group {{ @$field['group_class'] }}"
    ...
    {{--@include('jdesproduct::popup.add_category')--}}
    {{--@include('jdesproduct::popup.add_tag')--}}
@endsection
@section('custom_head')
