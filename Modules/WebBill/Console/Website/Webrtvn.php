...
class Webrtvn extends CrawlProductBase
{
...
//    protected $cat_link = 'https://webrt.vn/danhmuc/ban-dien-lanh-dien-may-dien-dan-dung/';
    ...
    protected $cat_name = 'Bán hàng';
    protected $cat_link = 'https://webrt.vn/danhmuc/kho-giao-dien/';
   ...
   // protected $cat_link = 'https://webrt.vn/danhmuc/web-dien-tu-dien-lanh/';
    ...
    public function crawlPageList($test = false)
    {
        ...
        while (!$stop) {
            ...
            $products_find = $html->find('.rt-md-web .list_theme .list_grd .item-theme');
            ...
            foreach ($products_find as $k => $product) {
                ...
                try {
                    ...
                    //  Lấy link sản phẩm
                    $product_link = $product->find('a.view-demo', 0);
                    ...
                    if ($product_link != $link_old) {
                        ...
                        if (is_object($product_exist)) {
                            if ($product->find('.post-thumbnail img', 0) != null) {
                                $product_data['image'] = $product->find('.post-thumbnail img', 0)->getAttribute('nitro-lazy-src');
                                if ($product_data['image'] == null) {
                                    $product_data['image'] == $product->find('.post-thumbnail img', 0)->getAttribute('src');
                                }
                            }
//                            dd($product_data);
                            ...
                            if ($product->find('.title', 0) != null) {
                                $product_data['name'] = $product->find('.title', 0)->innertext;
