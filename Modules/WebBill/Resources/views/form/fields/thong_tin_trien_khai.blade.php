<div class="kt-portlet">
    ...
    <div class="kt-form">
        <div class="kt-portlet__body">
            <div class="kt-section kt-section--first">
                ...
                <div class="form-group-div form-group {{ @$field['group_class'] }}"
                    ...
                    <label for="{{ $field['name'] }}">{{ @$field['label'] }} @if(strpos(@$field['class'], 'require') !== false)
                                <span class="color_btd">*</span>@endif</label>
                    <div class="col-xs-12">
                        @include('webbill::form.partials.select_dieu_hanh', ['field' => $field])
                        <span class="text-danger">{{ $errors->first($field['name']) }}</span>
                    </div>
                </div>
                ...
                <div class="form-group-div form-group {{ @$field['group_class'] }}"
                    ...
                    <label for="{{ $field['name'] }}">{{ @$field['label'] }} @if(strpos(@$field['class'], 'require') !== false)
                                <span class="color_btd">*</span>@endif</label>
                    <div class="col-xs-12">
                        @include('webbill::form.partials.select_ky_thuat', ['field' => $field])
                        <span class="text-danger">{{ $errors->first($field['name']) }}</span>
                    </div>
                </div>
            ...
            @include("webbill::dhbill.partials.lich_su_trang_thai")
        </div>
    </div>
    <!--end::Form-->
</div>
