...
class TPLeadController extends CURDBaseController
{
    ...
    protected $module = [
        ...
        'form' => [
            'general_tab' => [
                ...
                ['name' => 'tel', 'type' => 'custom', 'field' => 'webbill::lead.form.tel', 'class' => 'required', 'label' => 'SĐT', 'group_class' => 'col-md-3'],
    ...
    public function appendWhere($query, $request)
    {
        ...
        if (strpos($request->url(), '/tha-noi') !== false) {
	        ...
	        $members_ids = Admin::where('room_id', \Auth::guard('admin')->user()->room_id)->pluck('id')->toArray();
	  
	        $query = $query->where(function ($query) use ($members_ids) {
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('webbill::tplead.list')->with($data);
    }
