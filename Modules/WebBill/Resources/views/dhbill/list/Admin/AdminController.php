...
use Session;
use Validator;
use Modules\WebBill\Models\DailyWorkReport;
    ...
    protected $module = [
        ...
        'form' => [
            'general_tab' => [
                ...
                ['name' => 'email', 'type' => 'custom', 'field' => 'webbill::admin.form.email', 'class' => 'required', 'label' => 'admin.email', 'group_class' => 'col-md-3'],
                ['name' => 'tel', 'type' => 'custom', 'class' => 'required', 'field' => 'webbill::admin.form.tel', 'label' => 'admin.phone', 'group_class' => 'col-md-2'],
                ['name' => 'code', 'type' => 'custom', 'class' => 'required', 'field' => 'webbill::admin.form.code', 'label' => 'Mã nhân viên', 'group_class' => 'col-md-2'],
                ...
                /*['name' => 'role_id', 'type' => 'custom', 'field' => 'webbill::admin.partials.select_role', 'label' => 'Quyền', 'class' => 'required', 'model' => \App\Models\Roles::class, 'display_field' => 'display_name', 'group_class' => 'col-md-6'],*/
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('webbill::admin.add')->with($data);
            } else if ($_POST) {
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('webbill::admin.edit')->with($data);
            } else if ($_POST) {
...
//                }
    ...
    public function hieuSuatCongViec() {
        ...
        return view('webbill::admin.hieu_suat_cong_viec')->with($data);
    }
