...
use Modules\WebBill\Models\plan;
...
class PlanController extends CURDBaseController
{
    ...
    protected $module = [
        ...
        'table_name' => 'plans',
        'label' => 'Mục tiêu',
        'modal' => '\Modules\WebBill\Models\Plan',
        'list' => [
...
//            ['name' => 'expiry_date', 'type' => 'date_vi', 'label' => 'Hết hạn'],
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('webbill::plan.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('webbill::plan.add')->with($data);
            } else if ($_POST) {
                \DB::beginTransaction();
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('webbill::plan.edit')->with($data);
            } else if ($_POST) {
                \DB::beginTransaction();
