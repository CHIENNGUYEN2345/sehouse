...
class PenaltyTicketController extends CURDBaseController
{
    ...
    protected $module = [
        ...
        'label' => 'Phiếu phạt',
        'modal' => '\Modules\WebBill\Models\PenaltyTicket',
        'list' => [
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('webbill::penalty_ticket.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('webbill::penalty_ticket.add')->with($data);
            } else if ($_POST) {
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('webbill::penalty_ticket.edit')->with($data);
            } else if ($_POST) {
