...
class CodesController extends CURDBaseController
{
    ...
    protected $module = [
        ...
        'list' => [
            ...
            ['name' => 'multi_cat', 'type' => 'custom', 'td' => 'webbill::list.td.multi_cat', 'label' => 'Danh mục'],
        ...
        'form' => [
            'general_tab' => [
                ...
                ['name' => 'multi_cat', 'type' => 'custom', 'field' => 'webbill::form.fields.multi_cat', 'label' => 'Danh mục sản phẩm', 'model' => Category::class,
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('webbill::codes.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('webbill::codes.add')->with($data);
            } else if ($_POST) {
                \DB::beginTransaction();
    ...
    public function quickAdd(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                $data = $this->getDataAdd($request);
                return view('webbill::codes.quick_add')->with($data);
            } else if ($_POST) {
                $validator = Validator::make($request->all(), [
//                    'name' => 'required',
//                    'link' => 'required|unique:codes,link',
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('webbill::codes.edit')->with($data);
            } else if ($_POST) {
                \DB::beginTransaction();
...
//            CommonHelper::one_time_message('error', 'Lỗi hệ thống! Vui lòng liên hệ kỹ thuật viên.');
    ...
    public function updateBillToCode()
    {
        ...
        $count_bill_create = 0;
        $bills = \Modules\WebBill\Models\Bill::select('id', 'domain', 'service_id', 'update_to_codes')->where('update_to_codes', 0)->get();
