...
class ServiceController extends CURDBaseController
{
    ...
    protected $module = [
        ...
        'table_name' => 'services',
        'label' => 'Dịch vụ',
        'modal' => '\Modules\WebBill\Models\Service',
        'list' => [
...
die;
        ...
        return view('webbill::service.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('webbill::service.add')->with($data);
            } else if ($_POST) {
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('webbill::service.edit')->with($data);
            } else if ($_POST) {
...
//            CommonHelper::one_time_message('error', $ex->getMessage());
    ...
    public function show()
    {
        ...
        $data['page_type'] = 'list';
        return view('webbill::service.show')->with($data);
    }
