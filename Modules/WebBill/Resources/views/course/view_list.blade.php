    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body kt-portlet__body--fit">   
                ...
                <?php 
                $chang = \Modules\WebBill\Models\Category::select('id', 'name')->where('type', null);
                ...
                @foreach($chang as $ch => $chang_item)
                    ...
                    <?php 
                    $muc = \Modules\WebBill\Models\Category::select('id', 'name')->where('parent_id', $chang_item->id)->orderBy('order_no', 'asc')->get();
                    ?>
                          ...
                          <div class="accordion-group">
                            ...
                            <div id="collapse{{ $muc_item->id }}" class="accordion-body {{ $k == 0 ? 'collapse in' : 'collapse' }}">
                              <div class="accordion-inner">
                                <?php 
                                $courses = \Modules\WebBill\Models\Course::where('status', 1)->where('multi_cat', 'like', '%|'.$muc_item->id.'|%')->orderBy('order_no', 'asc')->get();
                                ?>
                                <ul>
