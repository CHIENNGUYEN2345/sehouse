    ...
    <div class="kho-code-form">
        <form method="GET" action="" id="form-search">
            ...
            <div class="col-xs-6 col-md-3">
                <?php
                $cats = \Modules\WebBill\Models\Category::select('id', 'name')->where('type', 10)->where('status', 1)->orderBy('name', 'asc')->get();
                ?>
            ...
            <div class="col-xs-6 col-md-3">
                <?php
                $tag_ids = \Modules\WebBill\Models\PostTag::where('multi_cat', 'like', '%|'.@$_GET['cat_id'].'|%')->groupBy('tag_id')->pluck('tag_id')->toArray();
                $tags = \Modules\WebBill\Models\Tag::whereIn('id', $tag_ids)->orderBy('name', 'asc')->get();
                ?>
