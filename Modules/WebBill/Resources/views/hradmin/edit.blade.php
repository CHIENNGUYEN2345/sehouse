                    ...
                    <div class="kt-form">
                        <div class="kt-portlet__body">
                            <div class="kt-section kt-section--first">
                                ...
                                <?php
                                $field = ['name' => 'role_id', 'type' => 'custom', 'field' => 'webbill::hradmin.partials.hr_select_role', 'label' => 'Quyền', 'class' => 'required', 'model' => \App\Models\Roles::class, 'display_field' => 'display_name'];
                                $field['value'] = @$result->{$field['name']};
                                ?>
