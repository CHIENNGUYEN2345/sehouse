...
@section('main')
    ...
    <form class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid {{ @$module['code'] }}"
        ...
        <div class="row">
            <div class="col-xs-12 col-md-8">
                <!--begin::Portlet-->
                @include('webbill::form.fields.thong_tin_thanh_toan')

                @include('webbill::form.fields.thong_tin_trien_khai')
                <!--end::Portlet-->
            ...
            <div class="col-xs-12 col-md-4">
                @include('webbill::form.fields.history_extension')
                        ...
                        <div class="kt-portlet__body">
                            <div class="log_action">
                                ...
                                <div class="form-group-div form-group col-md-12" id="form-group-name">
                                    <div class="col-xs-12">                                            
                                        <textarea type="text" placeholder="Kết quả chăm sóc" name="log_note" class="form-control required" ></textarea>
                                    </div>
                                </div>
                                <div class="form-group-div form-group col-md-12" id="form-group-name">
                            ...
                            <div class="log_logs">
                                <?php 
                            $logs = \Modules\WebBill\Models\LeadContactedLog::where('type', 'hđ')->where('lead_id', @$result->id)->orderBy('id', 'desc')->get();
                            ?>
                            @foreach($logs as $log)
                            <hr>
