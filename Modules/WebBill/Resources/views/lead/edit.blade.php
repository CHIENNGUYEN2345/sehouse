    ...
    <form class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid {{ @$module['code'] }}"
        ...
        <div class="row">
            <div class="col-xs-12 col-md-8">
                ...
                @include('webbill::lead.form.lich_su_tu_van')

                @include('webbill::lead.form.lich_su_hop_dong')
                    ...
                    <div class="kt-form">
                        <div class="kt-portlet__body">
                            ...
                            @if(in_array('lead_assign', $permissions) || strpos($result->saler_ids, '|'.\Auth::guard('admin')->user()->id.'|') !== false)
                                ...
                                <?php
                                    $field = ['name' => 'saler_ids', 'type' => 'custom', 'field' => 'webbill::lead.form.saler_ids', 'label' => 'Sale phụ trách', 'model' => \App\Models\Admin::class, 'object' => 'admin', 'display_field' => 'name', 'display_field2' => 'code', 'multiple' => true, 'group_class' => 'col-md-12'];
                                    $field['value'] = @$result->{$field['name']};
                                ?>
                                <div class="form-group-div form-group {{ @$field['group_class'] }}"
                                     id="form-group-{{ $field['name'] }}">
                            ...
                            <div class="form-group-div form-group {{ @$field['group_class'] }}"
                                ...
                                <div class="col-xs-12">
                                    @include('webbill::lead.form.doi_tac_cua_toi')
                                </div>
                            </div>
                        </div>
                    </div>
