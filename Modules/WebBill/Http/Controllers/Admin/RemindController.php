...
class RemindController extends CURDBaseController
{
    ...
    protected $module = [
        ...
        'list' => [
            ...
            ['name' => 'reminded', 'type' => 'custom', 'td' => 'webbill::list.td.multi_care', 'label' => 'Người nhận', 'object' => 'reminded'],
            ['name' => 'hours', 'type' => 'custom', 'td' => 'webbill::list.td.text_remind', 'label' => 'Giờ nhận', 'sort' => true],
            ['name' => 'day_l', 'type' => 'custom', 'td' => 'webbill::list.td.text_remind_date', 'label' => 'Thứ trong tuần nhận', 'sort' => true],
            ['name' => 'day', 'type' => 'custom', 'td' => 'webbill::list.td.text_remind', 'label' => 'Ngày nhận', 'sort' => true],
        ...
        'form' => [
            'general_tab' => [
                ...
                ['name' => 'reminded', 'type' => 'custom', 'type_history' => 'relation_multiple', 'field' => 'webbill::form.fields.select2_remind_model', 'multiple' => true, 'label' => 'Người nhận thông báo', 'model' => Admin::class, 'display_field' => 'name'],
...
//                    '00' => 00,
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('webbill::remind.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('webbill::remind.add')->with($data);
            } else if ($_POST) {
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('webbill::remind.edit')->with($data);
            } else if ($_POST) {
