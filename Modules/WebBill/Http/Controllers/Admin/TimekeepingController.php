...
class TimekeepingController extends CURDBaseController
{
    ...
    protected $module = [
        ...
        'label' => 'Chấm công',
        'modal' => '\Modules\WebBill\Models\Timekeeping',
        'list' => [
        ...
        'form' => [
            ...
            'tab_2' => [
                ...
                ['name' => 'saler_id', 'type' => 'custom', 'field' => 'webbill::timekeeping.form.fields.select_admin', 'label' => 'Sale', 'model' => Admin::class, 'object' => 'admin', 'display_field' => 'name', 'display_field2' => 'code', 'class' => 'required'],
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('webbill::timekeeping.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('webbill::timekeeping.add')->with($data);
            } else if ($_POST) {
                ...
                if ($validator->fails()) {
                    ...
                    $logs = [];
                    $lead_contacted_logs = \Modules\WebBill\Models\LeadContactedLog::select('lead_id', 'note', 'created_at')->where('admin_id', \Auth::guard('admin')->user()->id)
                    ...
                    $leads = \Modules\WebBill\Models\Lead::select('tel', 'name', 'created_at')->where('admin_id', \Auth::guard('admin')->user()->id)
                        ->where('created_at', '>=', date('Y-m-d 00:00:00', strtotime($data['day'])))
                        ->where('created_at', '<=', date('Y-m-d 23:59:59', strtotime($data['day'])))->orderBy('id', 'asc')->get();
                    foreach($leads as $v) {
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('webbill::timekeeping.edit')->with($data);
            } else if ($_POST) {
    ...
    public function view(Request $request) {
        ...
        $data = $this->getDataUpdate($request, $item);
        return view('webbill::timekeeping.view')->with($data);
    }
    ...
    public function show()
    {
        ...
        $data['page_type'] = 'list';
        return view('webbill::timekeeping.show')->with($data);
    }
    ...
    public function tooltipInfo(Request $r) {
        ...
        return view('webbill::timekeeping.tooltip_info')->with($data);
    }
    ...
    public function sendMail() {
        ...
        if ($settings['admin_receives_mail'] == 1) {
            ...
            foreach ($admins as $admin) {
                ...
                $data = [
                    'view' => 'webbill::timekeeping.emails.tien_do_cong_viec',
