...
class BillProgressHistoryController extends CURDBaseController
{
    ...
    protected $module = [
        ...
        'label' => 'Lịch sử',
        'modal' => '\Modules\WebBill\Models\BillProgressHistory',
        'list' => [
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('webbill::bill_progress_history.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            if (!$_POST) {
                ...
                return view('webbill::bill_progress_history.add')->with($data);
            } else if ($_POST) {
//                dd($request->all());
...
//            }
        ...
        if (!$_POST) {
            ...
            return view('webbill::bill_progress_history.edit')->with($data);
        } else if ($_POST) {
            $validator = Validator::make($request->all(), [
                'value' => 'required'
            ], [
...
//            }
    ...
    public function ajaxLichSuTrangThai(Request $request) {
        ...
        return view("webbill::dhbill.partials.lich_su_trang_thai_view")->with($data);
    }
}
