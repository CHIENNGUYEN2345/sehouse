...
namespace Modules\WebBill\Http\Controllers\Frontend;
...
//            dd($codes, $type);
        ...
        return view('webbill::frontend.pages.code.list')->with($data);
    }
    ...
    public function wordpressTrans(Request $r, $lang)
    {
        ...
        return view('webbill::frontend.pages.code.list_trans')->with($data);
    }
    ...
    public function app(Request $r)
    {
        ...
        return view('webbill::frontend.pages.code.list_app')->with($data);
    }
    ...
    public function appDetail(Request $r, $id) {
        ...
        return view('webbill::frontend.pages.code.detail_app')->with($data);
    }
...
//                    dd($request->all());
    ...
    public function wordpressDemo($id) {
        ...
        return view('webbill::frontend.pages.code.detail_wp')->with($data);
    }
