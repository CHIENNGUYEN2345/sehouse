...
namespace Modules\WebBill\Helpers;
...
//        echo WebBillHelper::processContentMail($camp->email_template->content, $list); die;

        $data = [
            'sender_account' => $camp->email_account,
            'user' => $user,
            'subject' => $camp->subject,
            'content' => WebBillHelper::processContentMail($camp->email_template->content, $list),
            'cc' => $cc
        ];
            ...
            foreach ($linkchecks as $item) {
                ...
                if (strpos($item->link, '.') != false) {
                    ...
                    if ($code == 0 || $code == 301 || $code == 302) {
                        ...
                        $code = WebBillHelper::reCheckLink($code, $linksDirect, $item->link, $ch);
                    }
                    ...
                    if ($code == 0) {
                        ...
                        $list[] = WebBillHelper::logs_error_link($code, $linkErrorLog);
