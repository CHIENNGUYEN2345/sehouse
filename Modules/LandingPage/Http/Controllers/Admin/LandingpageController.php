...
use Modules\LandingPage\Http\Helpers\LandingpageHelper;
use Auth;
use Illuminate\Http\Request;
use App\Http\Helpers\CommonHelper;
use Modules\LandingPage\Models\BillHistory;
use Modules\LandingPage\Models\Category;
...
class LandingpageController extends CURDBaseController
{
    ...
    protected $module = [
        ...
        'label' => 'Landingpage',
        'modal' => '\Modules\LandingPage\Models\Landingpage',
        'list' => [
            ['name' => 'domain', 'type' => 'custom', 'td' => 'landingpage::list.td.domain', 'label' => 'Tên miền'],
...
//                ['name' => 'name', 'type' => 'text', 'class' => 'required', 'label' => 'Tên web', 'group_class' => 'col-md-6'],
               /* ['name' => 'customer_id', 'object' => 'admin', 'type' => 'custom', 'field' => 'landingpage::form.fields.customer_id',
                ...
                ['name' => 'form_fields', 'type' => 'custom', 'field' => 'landingpage::form.fields.form_fields', 'object' => 'tours', 'class' => '',
            ...
            'customer_tab' => [
                ['name' => 'customer_id', 'type' => 'custom', 'type_history' => 'relation_multiple', 'field' => 'landingpage::form.fields.select_customer',
    ...
    {
        if (LandingpageHelper::getRoleType(\Auth::guard('admin')->user()->id) == 'customer') {
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('landingpage::add')->with($data);
            } else if ($_POST) {
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('landingpage::edit')->with($data);
            } else if ($_POST) {
