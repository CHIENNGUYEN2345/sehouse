...
if (!empty($value)) {
    ...
    // $data = $model->whereRaw($whereCompany)->whereIn('id', $value)->whereNotIn('id', $not_customer);
    $data = $model->whereRaw($whereCompany)->whereIn('id', $value);
...
@include('webbill::partials.customer_info')
