...
//            ['name' => 'expiry_date', 'type' => 'date_vi', 'label' => 'Hết hạn'],
            ...
            ['name' => 'price', 'type' => 'price_vi', 'label' => 'Số tiền', 'sort' => true],
        ],
        'form' => [
            'general_tab' => [
                ['name' => 'name_vi', 'type' => 'text', 'class' => 'required', 'label' => 'Tên', 'group_class' => 'col-md-6'],
                ['name' => 'code', 'type' => 'text', 'class' => '', 'label' => 'Mã', 'group_class' => 'col-md-6'],
                ['name' => 'price', 'type' => 'price_vi', 'class' => '', 'label' => 'Số tiền', 'group_class' => 'col-md-4'],
