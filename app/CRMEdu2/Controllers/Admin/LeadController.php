...
class LeadController extends CURDBaseController
{
    ...
    protected $module = [
        ...
        'list' => [
            ...
            ['name' => 'dating', 'type' => 'custom', 'td' => 'CRMEdu.lead.list.dating', 'label' => 'Hẹn ngày', 'sort' => true],
        ...
        'form' => [
            'general_tab' => [
                ...
                ['name' => 'tel', 'type' => 'custom', 'field' => 'CRMEdu.lead.form.tel', 'class' => 'required', 'label' => 'SĐT', 'group_class' => 'col-md-3'],
                ...
                ['name' => 'service_id', 'type' => 'select2_model', 'class' => ' ',  'label' => 'Lớp quan tâm', 'model' => Service::class, 'display_field' => 'name_vi', 'group_class' => 'col-md-3'],
            ...
            'tab_2' => [
                ['name' => 'profile', 'type' => 'textarea', 'label' => 'Chân dung học viên', 'group_class' => 'col-md-12', 'inner' => 'rows=5'],
    ...
    protected $quick_search = [
        'label' => 'ID, tên, sđt',
        'fields' => 'id, name, tel, rate, profile'
    ];
