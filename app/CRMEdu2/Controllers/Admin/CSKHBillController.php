...
class CSKHBillController extends CURDBaseController
{
    ...
    protected $module = [
        ...
        'list' => [
            ...
            ['name' => 'service_id', 'type' => 'relation', 'label' => 'Lớp học', 'object' => 'service', 'display_field' => 'name_vi'],
            ['name' => 'total_price', 'type' => 'price_vi', 'label' => 'Số $'],
//            ['name' => 'count_product', 'type' => 'custom', 'td' => 'CRMEdu.cskh_bill.list.td.count_product', 'label' => 'Tổng SP'],
            ...
            ['name' => 'expiry_date', 'type' => 'date_vi', 'label' => 'Ngày k.thúc'],
...
//
            ...
            'service_tab' => [
                ['name' => 'service_id', 'type' => 'radio_model', 'class' => '', 'label' => 'Lớp học', 'model' => Service::class, 'display_field' => 'name_vi'],
            ],
            'account_tab' => [
            ],
//            'histories_bill_tab' => [
...
//            ],
    ...
    public function appendWhere($query, $request)
    {
        ...
        $query = $query->where('domain', 'LIKE', '%.%')    //  lấy hđ có tên miền có dấu .
                            ->whereNotIn('service_id', [    //   ko lấy tên miền ở các  hợp đồng cho các Lớp học sau:
                                4,  //  dv mail
                                7,  //  dv duy trì
