    ...
    <div class="container">
        ...
        <div class="row">
            ...
            @foreach($ds_dieu_hanh as $admin)
                <?php 
                    $so_da_dang_lam = App\CRMEdu\Models\BillProgress::whereIn('status', [
                                    'Thu thập YCTK L1',
                                    'Triển khai L1',
                        ...
                        <!--begin::Toolbar-->
                            ...
                            <!-- <p class="mb-7">I distinguish three 
                                ...
                                <div class="mb-7 noi-dung">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <span class="text-dark-75 font-weight-bolder mr-2">Lớp học đã dạy:</span>
                                        <a href="mailto:{{ $admin->email }}" class="text-muted text-hover-primary">{{ $so_da_da_lam }}</a>
                                    </div>
                                    <div class="d-flex justify-content-between align-items-cente my-1">
                                        <span class="text-dark-75 font-weight-bolder mr-2">Lớp học đang dạy:</span>
                                        <a href="https://zalo.me/{{ $admin->tel }}" class="text-muted text-hover-primary">{{ $so_da_dang_lam }}</a>
                                    </div>
                                </div>
                                <div class="mb-7 noi-dung">
