...
@section('main')
    ...
    if (!$bill_warning) {
        // ====|Min|======|Now|=====|Closed|======|Max|======>
        $bill_warning = \App\CRMEdu\Models\Bill::select('service_id', 'customer_id', 'id', 'created_at', 'total_price', 'exp_price', 'expiry_date', 'domain', 'auto_extend')
    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        <div class="row">
            @include('CoreERP.dashboard.partials.huong_dan.video_huong_dan')
        </div>
        <div class="row">
