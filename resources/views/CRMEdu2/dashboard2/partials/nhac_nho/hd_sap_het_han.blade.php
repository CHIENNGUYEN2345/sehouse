            ...
            <div class="kt-portlet__head-wrapper">
                <div class="kt-portlet__head-actions" style="display: flex; text-align: center">
                    <div class="col-sm-6">
                        ...
                        <span class="kt-widget12__value font-weight-bold">{{number_format(\App\CRMEdu\Models\Bill::where('expiry_date', 'like', date('Y') . '-' . date('m') . '-%')->where('auto_extend', 1)->where('status', 1)->whereNull('bill_parent')->sum('exp_price'), 0, '.', '.')}}<sup>đ</sup></span>
                    </div>

                    <div class="col-sm-6">
                        <span class="kt-widget12__desc">Tổng tiền gia hạn cần thu trong tháng sau</span><br>
                        <span class="kt-widget12__value font-weight-bold">{{number_format(\App\CRMEdu\Models\Bill::select('exp_price')->where('expiry_date', 'like', date('Y') . '-' . $next_month . '-%')->where('auto_extend', 1)->where('status', 1)->whereNull('bill_parent')->sum('exp_price'), 0, '.', '.')}}<sup>đ</sup></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="kt-datatable kt-datatable--default kt-datatable--brand kt-datatable--scroll kt-datatable--loaded"
            ...
            <table class="kt-datatable__table" style=" width: 100%;">
                ...
                <tr class="kt-datatable__row" style="left: 0px;">
                    ...
                    <th class="kt-datatable__cell kt-datatable__cell--sort">
                        <span style="width: 100px;">Tên học viên hàng</span>
                    </th>
                    <th class="kt-datatable__cell kt-datatable__cell--sort">
