    ...
    <div class="kt-form">
        <div class="kt-portlet__body">
            <div class="kt-section kt-section--first">
                ...
                <?php
                $field = ['name' => 'customer_classify', 'type' => 'select', 'label' => 'Phân loại học viên', 'class' => ' required', 'group_class' => 'col-md-3', 'value' => isset($result) ? @$result->customer->classify : '', 'options' => [
                    '-' => '',
                ...
                <?php
                $field = ['name' => 'progress_dh_id', 'type' => 'custom', 'label' => 'NV Trợ giảng', 'class' => 'required', 'group_class' => 'col-md-3', 'value' => isset($result) ? @$result->bill_progress->dh_id : '',];
                ?>
                <div class="form-group-div form-group {{ @$field['group_class'] }}"
                     id="form-group-{{ $field['name'] }}">
                    <label for="{{ $field['name'] }}">{{ @$field['label'] }} @if(strpos(@$field['class'], 'require') !== false)
                ...
                <?php
                $field = ['name' => 'progress_kt_id', 'type' => 'custom', 'label' => 'NV giảng viên', 'class' => 'required', 'group_class' => 'col-md-3', 'value' => isset($result) ? @$result->bill_progress->kt_id : '',];
                ?>
                <div class="form-group-div form-group {{ @$field['group_class'] }}"
                     id="form-group-{{ $field['name'] }}">
                    <label for="{{ $field['name'] }}">{{ @$field['label'] }} @if(strpos(@$field['class'], 'require') !== false)
