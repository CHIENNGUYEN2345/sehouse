...
@section('main')
    ...
    if (!$bill_warning) {
        // ====|Min|======|Now|=====|Closed|======|Max|======>
        $bill_warning = \App\CRMDV\Models\Bill::select('service_id', 'customer_id', 'id', 'created_at', 'total_price', 'exp_price', 'expiry_date', 'domain', 'auto_extend', 'saler_id')
    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 order-xl-1">
                @include('CRMEdu.dashboard.partials.nhac_nho.hd_no_tien')
            </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 order-xl-1">
                @include('CRMEdu.dashboard.partials.nhac_nho.hd_cham_tien_do')
            </div>
