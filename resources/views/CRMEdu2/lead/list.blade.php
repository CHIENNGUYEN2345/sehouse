                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        @if(in_array('lead_float_view', $permissions))
                            <div>
                                <a href="/admin/lead"
                                   class="btn {{ strpos($_SERVER['REQUEST_URI'], '/tha-noi') == false && strpos($_SERVER['REQUEST_URI'], '/quan-tam-moi') == false ? 'btn-primary' : 'btn-default' }}">học
                                    viên
                                    của tôi</a>
                                <a href="/admin/lead/tha-noi"
                                   class="btn {{ strpos($_SERVER['REQUEST_URI'], '/tha-noi') != false ? 'btn-primary' : 'btn-default' }}">học
                                    viên
                                    thả nổi</a>
